...
anomalies_lag3 =
  ...
  mutate(                                                           ## creating lags within weekly ENACTS dataset
    ...
    lag9 = lag(wk_pos_t_anomaly, 9,  order_by = woy3),
    lag10 = lag(wk_pos_t_anomaly, 10, order_by = woy3),
    lag11 = lag(wk_pos_t_anomaly, 11, order_by = woy3),
    lag12 = lag(wk_pos_t_anomaly, 12, order_by = woy3),
    lag13 = lag(wk_pos_t_anomaly, 13, order_by = woy3),
    lag14 = lag(wk_pos_t_anomaly, 14, order_by = woy3),
    lag15 = lag(wk_pos_t_anomaly, 15, order_by = woy3),
    lag16 = lag(wk_pos_t_anomaly, 16, order_by = woy3)
  )
...
adj_lag_data =
  ...
  select(everything(), lag0 = wk_pos_t_anomaly)
...
# test_results_crude =
#   tibble(beta1_df = c('lag0', 'lag1', 'lag2', 'lag3', 'lag4', 'lag5', 'lag6', 'lag7', 'lag8', 'lag9', 'lag10', 'lag11', 'lag12', 'lag13', 'lag14', 'lag15', 'lag16')) %>% 
#   mutate(
